...
module.exports = {
    ...
    callback: async ({ msg, fullArgs }) => {
        let { data } = await axios.get('https://api.lolhuman.xyz/api/jooxplay?apikey={apikey}&query={query}'.format({ apikey: config.apikey, query: fullArgs })).catch(() => { return msg.reply('Terjadi kesalahan') })
